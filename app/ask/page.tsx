        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {response.numbers_used.map((num, i) => (
              <span key={i} className="inline-flex items-center px-2.5 py-1 rounded-md text-xs bg-gray-100 text-gray-700 border border-gray-200">
                  ...
                  <div className="h-full flex items-center justify-center">
                    <div className="text-center text-gray-500">
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        Click a quick question or type your own to get started
                      </p>
                    </div>
                  </div>
                ) : (
              ...
              <div className="border-t p-4">
                <form onSubmit={handleFormSubmit} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-md border border-gray-300 bg-white text-gray-900 px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder:text-gray-400"
                    disabled={isLoading}
                  />
